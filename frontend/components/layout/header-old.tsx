...
export default function Header() {
  ...
  const processUserData = (rawUserData: any) => {
    return {
      email: rawUserData.email || "",
      username: rawUserData.username || "",
      profile: {
        avatar: rawUserData.profile?.avatar || null,
        avatar_url: rawUserData.profile?.avatar_url || null,
        ...
        has_custom_avatar: rawUserData.profile?.has_custom_avatar || false,
  ...
  // 아바타 색상 클래스 (백엔드에서 제공)
  const avatarColorClass = userData.profile?.avatar_color_class || "from-blue-500 to-purple-600"
                      ...
                      <div className="p-4 border-b bg-gray-50">
                        ...
                        >
                          <Avatar className="w-12 h-12">
                            ...
                            <AvatarFallback
                              className={`text-lg font-bold text-white border-2 border-white shadow-sm bg-gradient-to-br ${avatarColorClass} ${
                                !avatarColorClass.includes('from-') ? 'bg-blue-500' : ''
                              }`}
                            >
                            </AvatarFallback>
